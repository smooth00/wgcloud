...
function doHandleYear(){var myDate=new Date();var tYear=myDate.getFullYear();$("#copyyear").html(tYear)}function getVersion(){$.getScript("/static/js/jQuery/new-version.min.js")}$(document).ready(function(){doHandleYear();setTimeout("getVersion()",10000)});